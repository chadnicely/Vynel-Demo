...
// (refetch + overlay swap) on turn end. The TRACE-kind lifecycle keeps its
// coverage in use-delegation-trace-live.test.ts, which now runs through the
// adapter — the same code path.
