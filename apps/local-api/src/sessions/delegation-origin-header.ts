...
// global-root turn runner to the `POST /routing/message` route (brain-tree Ch4). The runner
...
// routing MCP tool (`send_message`) from the model's tool input — the origin is AMBIENT
