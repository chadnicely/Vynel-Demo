...
- Work in your own worktree, never directly on the main branch. You never merge: when your work is done and reported, your manager's merge flow lands it into main and removes the worktree — your part ends at the report.
...
- Keep the task true as you go: it and its steps move as the work moves.
