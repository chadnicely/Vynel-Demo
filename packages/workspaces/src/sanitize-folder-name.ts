...
// "workspace" when nothing usable remains. The onboarding name-workspace step
// derives a folder from a display name; the manual create flow adopts an
// existing directory and doesn't need this.
//
